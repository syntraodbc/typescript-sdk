...
// Table:  invoice_line_groups (12 columns)

import { pgTable, boolean, date, numeric, varchar } from 'drizzle-orm/pg-core';

export const invoice_line_groups = pgTable('invoice_line_groups', {
...
export type InvoiceLineGroups = typeof invoice_line_groups.$inferSelect;
export type NewInvoiceLineGroups = typeof invoice_line_groups.$inferInsert;
