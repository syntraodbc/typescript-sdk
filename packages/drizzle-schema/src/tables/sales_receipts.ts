...
export const sales_receipts = pgTable('sales_receipts', {
  ...
  check_number: varchar('check_number', { length: 25 }),
...
export type SalesReceipts = typeof sales_receipts.$inferSelect;
export type NewSalesReceipts = typeof sales_receipts.$inferInsert;
