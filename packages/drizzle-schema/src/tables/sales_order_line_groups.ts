...
// Table:  sales_order_line_groups (11 columns)

import { pgTable, boolean, numeric, varchar } from 'drizzle-orm/pg-core';

export const sales_order_line_groups = pgTable('sales_order_line_groups', {
...
export type SalesOrderLineGroups = typeof sales_order_line_groups.$inferSelect;
export type NewSalesOrderLineGroups = typeof sales_order_line_groups.$inferInsert;
