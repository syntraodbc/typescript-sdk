...
// Table:  payroll_liability_adjustments (18 columns)

import { pgTable, boolean, date, integer, numeric, timestamp, varchar } from 'drizzle-orm/pg-core';

export const payroll_liability_adjustments = pgTable('payroll_liability_adjustments', {
...
export type PayrollLiabilityAdjustments = typeof payroll_liability_adjustments.$inferSelect;
export type NewPayrollLiabilityAdjustments = typeof payroll_liability_adjustments.$inferInsert;
