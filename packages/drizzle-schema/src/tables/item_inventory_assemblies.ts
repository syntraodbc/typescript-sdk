...
// Table:  item_inventory_assemblies (40 columns)

import { pgTable, boolean, integer, numeric, timestamp, varchar } from 'drizzle-orm/pg-core';

export const item_inventory_assemblies = pgTable('item_inventory_assemblies', {
  ...
  build_point: numeric('build_point', { precision: 12, scale: 5 }),
...
export type ItemInventoryAssemblies = typeof item_inventory_assemblies.$inferSelect;
export type NewItemInventoryAssemblies = typeof item_inventory_assemblies.$inferInsert;
