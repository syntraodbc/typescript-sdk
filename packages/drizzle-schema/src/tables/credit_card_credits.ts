...
// Table:  credit_card_credits (21 columns)

import { pgTable, boolean, date, integer, numeric, timestamp, varchar } from 'drizzle-orm/pg-core';

export const credit_card_credits = pgTable('credit_card_credits', {
...
export type CreditCardCredits = typeof credit_card_credits.$inferSelect;
export type NewCreditCardCredits = typeof credit_card_credits.$inferInsert;
