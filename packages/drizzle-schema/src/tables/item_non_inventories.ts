...
// Table:  item_non_inventories (37 columns)

import { pgTable, boolean, integer, numeric, timestamp, varchar } from 'drizzle-orm/pg-core';

export const item_non_inventories = pgTable('item_non_inventories', {
...
export type ItemNonInventories = typeof item_non_inventories.$inferSelect;
export type NewItemNonInventories = typeof item_non_inventories.$inferInsert;
