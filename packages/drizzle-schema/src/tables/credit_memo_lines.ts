...
// Table:  credit_memo_lines (44 columns)

import { pgTable, boolean, date, integer, numeric, timestamp, varchar } from 'drizzle-orm/pg-core';

export const credit_memo_lines = pgTable('credit_memo_lines', {
...
export type CreditMemoLines = typeof credit_memo_lines.$inferSelect;
export type NewCreditMemoLines = typeof credit_memo_lines.$inferInsert;
