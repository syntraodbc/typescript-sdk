...
// Table:  purchase_order_line_groups (12 columns)

import { pgTable, boolean, date, numeric, varchar } from 'drizzle-orm/pg-core';

export const purchase_order_line_groups = pgTable('purchase_order_line_groups', {
...
export type PurchaseOrderLineGroups = typeof purchase_order_line_groups.$inferSelect;
export type NewPurchaseOrderLineGroups = typeof purchase_order_line_groups.$inferInsert;
