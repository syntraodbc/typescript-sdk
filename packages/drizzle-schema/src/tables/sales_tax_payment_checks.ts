...
// Table:  sales_tax_payment_checks (30 columns)

import { pgTable, boolean, date, integer, numeric, timestamp, varchar } from 'drizzle-orm/pg-core';

export const sales_tax_payment_checks = pgTable('sales_tax_payment_checks', {
...
export type SalesTaxPaymentChecks = typeof sales_tax_payment_checks.$inferSelect;
export type NewSalesTaxPaymentChecks = typeof sales_tax_payment_checks.$inferInsert;
