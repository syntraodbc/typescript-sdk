...
// Table:  sales_receipt_line_groups (12 columns)

import { pgTable, boolean, date, numeric, varchar } from 'drizzle-orm/pg-core';

export const sales_receipt_line_groups = pgTable('sales_receipt_line_groups', {
...
export type SalesReceiptLineGroups = typeof sales_receipt_line_groups.$inferSelect;
export type NewSalesReceiptLineGroups = typeof sales_receipt_line_groups.$inferInsert;
